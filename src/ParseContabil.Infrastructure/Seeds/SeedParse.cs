            ...
            return new List<Template>
               {
                   ...
                   new (){RecordTypeId = id, Order = 2, Size = 5, Head = "Código de empresa", TypeData = "string"},
                   ...
                   new (){RecordTypeId = id, Order = 6, Size = 30,Head = "Descripción de la cuenta" ,TypeData = "string"},
                   ...
                   new (){RecordTypeId = id, Order = 9, Size = 1,Head = "Línea de apunte" ,TypeData = "string"},
                   new (){RecordTypeId = id, Order = 10, Size = 30,Head = "Descripción del apunte" ,TypeData = "string"},
                   ...
                   new (){RecordTypeId = id, Order = 13, Size = 1,Head = "Indicador de Asiento de nómina" ,TypeData = "string"},
                   new (){RecordTypeId = id, Order = 14, Size = 1,Head = "Tiene Registro Analítico" ,TypeData = "string"},
            ...
            return  new List<Template>
                {
                    ...
                    new (){RecordTypeId = id, Order = 15, Size = 5,Head = "Código postal" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 16, Size = 2,Head = "Reserva" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 17, Size = 8,Head = "Fecha de operación" ,TypeData = "date"},
                    new (){RecordTypeId = id, Order = 18, Size = 8,Head = "Fecha de factura" ,TypeData = "date"},
                    new (){RecordTypeId = id, Order = 19, Size = 60,Head = "Número factura ampliado para el SII" ,TypeData = "string"},
            ...
            return  new List<Template>
                {
                    ...
                    new (){RecordTypeId = id, Order = 17, Size = 5,Head = "Porcentaje de Retención" ,TypeData = "decimal"},
                    new (){RecordTypeId = id, Order = 18, Size = 14,Head = "Cuota de Retención" ,TypeData = "date"},
                    new (){RecordTypeId = id, Order = 19, Size = 1,Head = "Operación sujeta a IVA" ,TypeData = "date"},
                    ...
                    new (){RecordTypeId = id, Order = 25, Size = 12,Head = "Cuenta de retención" ,TypeData = "string"},
                    ...
                    new (){RecordTypeId = id, Order = 28, Size = 1,Head = "Tiene Registro Analítico" ,TypeData = "string"},
            ...
            return  new List<Template>
                {
                    ...
                    new (){RecordTypeId = id, Order = 9, Size = 1,Head = "Ampliación" ,TypeData = "string"},
                    ...
                    new (){RecordTypeId = id, Order = 13, Size = 30,Head = "Vía Publica" ,TypeData = "string"},
                    ...
                    new (){RecordTypeId = id, Order = 19, Size = 5,Head = "Código Postal" ,TypeData = "string"},
                    ...
                    new (){RecordTypeId = id, Order = 22, Size = 12,Head = "Teléfono" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 23, Size = 4,Head = "Extensión" ,TypeData = "string"},
                    ...
                    new (){RecordTypeId = id, Order = 30, Size = 2,Head = "Código de país" ,TypeData = "string"},
