            ...
            return  new List<Template>
                {
                    ...
                    new (){RecordTypeId = id, Order = 18, Size = 14,Head = "Cuota de Retencion" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 19, Size = 2,Head = "error template" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 20, Size = 1,Head = "Operacion sujeta a IVA" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 21, Size = 1,Head = "Marca afecta 415" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 22, Size = 1,Head = "Marca factura en criterio de caja" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 23, Size = 14,Head = "reserva" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 24, Size = 12,Head = "Cuenta de IVA Soportado" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 25, Size = 12,Head = "Cuenta de recargo Soportado" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 26, Size = 12,Head = "Cuenta de retencion" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 27, Size = 12,Head = "Cuenta de IVA 2 Repercutido" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 28, Size = 12,Head = "Cuenta de recargo 2 Repercutid" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 29, Size = 1,Head = "Tiene Registro Analitico" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 30, Size = 256,Head = "reserva" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 31, Size = 1,Head = "Moneda enlace" ,TypeData = "string"},
                    new (){RecordTypeId = id, Order = 32, Size = 1,Head = "Indicador de generado" ,TypeData = "string"},
            };
        }
